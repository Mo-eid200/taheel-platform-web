      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/35 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-5 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            {/* ✅ Logo: perfect circle + white background (NOT oval) */}
            <div className="relative h-14 w-14 md:h-16 md:w-16 aspect-square rounded-full bg-white ring-1 ring-black/10 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.9)] overflow-hidden">
              <Image
                src="/logo3.png"
                alt="TAHEEL"
                fill
          ...
          >
            <div className="lg:col-span-7">
              ...
              <p className="mt-5 text-white/75 leading-relaxed text-lg">
                تأهيل منصة متخصصة لإدارة الخدمات الحكومية للأفراد والشركات داخل
                دولة الإمارات — بأسلوب حديث يجمع الخبرة العملية والتنظيم الرقمي
                وسهولة التنفيذ عن بُعد، مع تتبع وإشعارات وشفافية في كل خطوة.
              </p>
              ...
              <Card className="p-6 h-full">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-1 text-white/70 text-sm">
                      From the future beginning
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <div className="rounded-2xl bg-white/10 ring-1 ring-white/15 px-3 py-2 text-xs">
                      Pulse G1
                    </div>
                    <div className="rounded-2xl bg-white/10 ring-1 ring-white/15 px-3 py-2 text-xs">
                      Atlas G1
                ...
                <div className="mt-6 rounded-3xl bg-black/25 ring-1 ring-white/10 p-5">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-white/75">
                    {[
                      ...
                      <div
                        key={i}
                        className="rounded-2xl bg-white/5 ring-1 ring-white/10 px-3 py-2"
                      >
                        {t}
                      </div>
                    ))}
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Card className="p-5">
                    ...
                    <div className="mt-2 text-sm text-white/70">
                      Android & iOS — تجربة حكومية مختلفة.
                    </div>

                    <div className="mt-4 space-y-3">
                      <FancyButton
                        href="https://www.taheel.ae/p/u/taheel-goverment-services?lang=ar"
                        variant="primary"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <div className="mt-5 text-xs text-white/55 leading-relaxed">
                      * الروابط الرسمية مفعّلة على Google Play و App Store.
                    </div>
                  </Card>
                </div>
              </Card>
        ...
        <div className="mx-auto max-w-7xl px-5 pb-20 space-y-14">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <Card className="p-6 lg:col-span-7">
                <div className="text-white/80 leading-relaxed space-y-4">
                  <p>
                    تأهيل ليست مكتب معاملات تقليدي، ولا تُحمّل العميل عبء التنقل
                    بين الجهات أو زيارة مراكز الخدمة. نحن{" "}
                    <b>منصة تشغيل رقمية</b> تستقبل الطلب، تنظمه، تراجعه، تتابعه،
                    وتوثقه ضمن منظومة واضحة.
                  </p>
                  <p>
                    هدفنا تحويل التجربة الحكومية من إجراءات متفرقة إلى عمليات
                    منظمة تُدار رقميًا: <b>تقليل التعقيد</b>، <b>تسريع التنفيذ</b>،
                    و<b>ضمان الشفافية</b> في كل خطوة.
                  </p>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    {
                      icon: Layers,
                      t: "من الرؤية إلى التطبيق",
                      d: "تطبيق عملي لتحويل البيروقراطية إلى عمليات رقمية منظمة.",
                    },
                    {
                      icon: Users,
                      t: "حل متكامل للأفراد والشركات",
                      d: "نفس المنهجية — مع تخصيص الخدمة حسب نوع العميل.",
                    },
                    {
                      icon: Workflow,
                      t: "وضوح المسؤوليات",
                      d: "توزيع ذكي للطلبات + تتبع يوضح من يفعل ماذا ومتى.",
                    },
                    {
                      icon: FileText,
                      t: "توثيق كامل",
                      d: "كل خطوة محفوظة داخل النظام لضمان المصداقية.",
                    },
                  ].map((x, i) => (
                    <div
                      key={i}
                      className="rounded-3xl bg-black/20 ring-1 ring-white/10 p-5"
                    >
              ...
              <Card className="p-6 lg:col-span-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">
                      دعم التحول الرقمي ومبادئ “تصفير البيروقراطية”
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 space-y-3 text-white/75 leading-relaxed">
                  <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4">
                    • تبسيط الإجراءات
                    <br />• تقليل الخطوات غير الضرورية
                    <br />• تحسين تجربة المتعامل
                  </div>
                  <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                {
                  icon: Workflow,
                  title: "منصة تشغيل… وليست مكتب معاملات",
                  desc: "إدارة رقمية كاملة عن بُعد — بدون تنقل بين المراكز وبدون اعتماد على مصادر غير موثوقة.",
                },
                {
                  icon: Cpu,
                  title: "إدارة ذكية مدعومة بتقنية QXT",
                  desc: "تنظيم العمليات الحكومية المعقدة وربط الخطوات وتقليل التدخل اليدوي — مع معايير تشغيل موحدة.",
                },
                {
                  icon: Gauge,
                  title: "كل شيء عن بُعد… بدون انتظار",
                  desc: "استقبال الطلب وتنفيذه ومتابعته ضمن منظومة واضحة — سرعة ودقة وشفافية في كل مرحلة.",
                },
              ].map((x, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <Card className="p-6 lg:col-span-5">
                ...
                <div className="mt-3 space-y-3 text-white/75 leading-relaxed">
                  <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4">
                    • تقديم رقمي عبر التطبيق أو الموقع
                    <br />
                    • توزيع ذكي للطلبات
                    <br />
                    • مراجعة تقنية وبشرية
                    <br />
                    • تواصل واضح عند الحاجة
                    <br />
                    • متابعة لحظية حتى الإنهاء
                  </div>
                  <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4">
                    كل ذلك ضمن منظومة واحدة تجعل الخدمات الحكومية أبسط، أوضح،
                    وأكثر كفاءة.
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 lg:col-span-7">
                <div className="font-extrabold text-lg mb-4">
                  مسار التنفيذ (Operational Flow)
                </div>
                <div className="space-y-3">
                  {workflow.map((s, idx) => (
                    <div
                      key={idx}
                      className="rounded-3xl bg-black/18 ring-1 ring-white/10 p-5"
                    >
                      <div className="flex items-start gap-3">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <Card className="p-6 lg:col-span-7">
                <div className="text-white/80 leading-relaxed space-y-4">
                  <p>
                    الإقامة الذهبية تعتمد على معايير دقيقة وتقييم شامل للملف،
                    وليس فقط استيفاء مستندات شكلية. لذلك نتعامل معها كنظام تقييم
                    متكامل.
                  </p>
                  ...
                  <div className="rounded-3xl bg-black/20 ring-1 ring-white/10 p-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/70">
                          محاكاة منطق التقييم لدى الجهات المختصة لتحديد القوة
                          والثغرات وتحسين عرض الملف.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-3xl bg-black/20 ring-1 ring-white/10 p-5">
                    ...
                    <div className="mt-2 text-white/70 leading-relaxed">
                      إعداد + تدقيق + تقديم + متابعة حتى القرار النهائي، مع إبقاء
                      العميل على اطلاع كامل بكل مرحلة.
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 lg:col-span-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">
                      الفارق بين تقديم طلب… وإدارة ملف مؤهل للقبول.
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 space-y-3 text-white/75">
                  {[
                    ...
                    <div
                      key={i}
                      className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4 flex items-start gap-2"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <Card className="p-6 lg:col-span-6">
                <div className="font-extrabold text-lg">
                  التكامل بين الذكاء الاصطناعي والخبرة البشرية
                </div>
                <div className="mt-3 text-white/75 leading-relaxed">
                  لا يُستخدم الذكاء الاصطناعي كبديل عن الإنسان، بل كأداة دعم ورفع
                  جودة: تحليل أولي وتنظيم، ثم اعتماد نهائي عبر فريق متخصص.
                </div>
              ...
              {[
                {
                  ...
                  desc: "تشفير أثناء النقل والتخزين + صلاحيات دقيقة + تسجيل وتتبع كامل لكل عملية.",
                },
                {
                  icon: ShieldCheck,
                  title: "تشغيل آمن ومراقبة",
                  desc: "حماية ضد الاختراق + مراقبة الاستخدام + تحديثات أمنية دورية + فصل بيئات حساسة.",
                },
                {
                  icon: BadgeCheck,
                  title: "الجودة وتوحيد الخدمة",
                  desc: "إجراءات واضحة + مراجعات متعددة + توثيق كامل + تقليل الأخطاء البشرية.",
                },
              ].map((x, i) => (
                <Card key={i} className="p-6">
                  <x.icon className="h-7 w-7" />
            ...
            <Card className="p-6 mt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/70">
                    إشعارات واضحة وتحديثات حالة مستمرة ومسار تتبع لكل طلب.
                  </div>
                </div>
              </div>
            </Card>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <Card className="p-6 lg:col-span-7">
                ...
                <div className="mt-3 text-white/75 leading-relaxed">
                  إدارة معاملات متنوعة تشمل تأسيس وتشغيل شركات، شؤون الموظفين،
                  الإقامات، التأشيرات، والخدمات الحكومية المرتبطة بها.
                </div>
                <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-white/75">
                  {[
                    "تنظيم دقيق للملفات",
                    "فهم عميق للإجراءات",
                    "تقديم مدروس قبل رفع الطلب",
                    "توثيق ومسار واضح لكل طلب",
                  ].map((t, i) => (
                    <div
                      key={i}
                      className="rounded-2xl bg-black/20 ring-1 ring-white/10 p-4"
              ...
              <Card className="p-6 lg:col-span-5">
                ...
                <div className="mt-3 text-white/75 leading-relaxed">
                  تطبيق فعلي لمبادئ التنظيم وتقليل الأخطاء وتقديم مكتمل من أول مرة
                  — مع تجربة رقمية واضحة.
                </div>
                <div className="mt-5 flex flex-wrap gap-2">
                  <Pill>تبسيط</Pill>
                  <Pill>تقليل التعقيد</Pill>
                  <Pill>تسريع الإنجاز</Pill>
                  <Pill>تحسين تجربة المتعامل</Pill>
                </div>
              </Card>
            </div>
          </Section>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
              {plans.map((p) => (
                <Card key={p.key} className="p-6 relative overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-gradient-to-tr ${p.color} pointer-events-none`}
                  />
            ...
            <Card className="p-6 mt-6">
              ...
              <div className="mt-2 text-white/70 leading-relaxed">
                Pay Per Request (Limited) — متاح لمن يريد تجربة الخدمة أو معاملات
                خاصة متعددة الجهات بتسعير حسب الطلب.
              </div>
            ...
            <Card className="p-6 mt-6">
              ...
              <div className="mt-2 text-white/70 leading-relaxed text-sm">
                • الأسعار إرشادية وقد تختلف حسب نوع المعاملة والجهة الحكومية أو
                تحديثات الأنظمة الرسمية.
                <br />• لا تشمل الباقات الرسوم الحكومية الرسمية أو الغرامات، ويتم
                تحصيلها حسب الجهة المختصة.
                <br />• مدة إنجاز الطلبات تعتمد على الجهة الحكومية المعنية، ولا
                تتحكم تأهيل في زمن القرار النهائي.
                <br />• تخضع جميع الخدمات للأنظمة والقوانين المعمول بها داخل دولة
              ...
              <Card className="p-6 lg:col-span-7">
                <div className="space-y-3">
                  <AccordionItem title="1) طبيعة الخدمة" defaultOpen>
                    تأهيل منصة رقمية متخصصة في إدارة ومتابعة المعاملات الحكومية
                    للأفراد والشركات داخل دولة الإمارات، وتعمل كوسيط تنظيمي وتقني
                    لإعداد الطلبات، مراجعتها، متابعتها، وتقديمها للجهات الحكومية
                    المختصة، ولا تُعد جهة حكومية أو جهة اتخاذ قرار.
                  </AccordionItem>

                  <AccordionItem title="2) نطاق المسؤولية">
                    • تقتصر مسؤولية تأهيل على تنظيم الطلبات، مراجعة المستندات،
                    المتابعة الإجرائية، والتواصل مع الجهات الحكومية المختصة.
                    <br />• لا تتحمل تأهيل مسؤولية عن قرارات القبول أو الرفض
                    الصادرة عن الجهات الحكومية.
                    <br />• لا تضمن تأهيل صدور قرار إيجابي لأي طلب حتى في حال
                    استيفاء المتطلبات.
                  </AccordionItem>

                  <AccordionItem title="3) الأسعار والرسوم">
                    • الأسعار إرشادية وقابلة للتغيير حسب نوع المعاملة والجهة
                    الحكومية وتحديثات الأنظمة.
                    <br />• لا تشمل الاشتراكات رسومًا حكومية رسمية أو غرامات أو
                    رسوم طرف ثالث.
                    <br />• يقر العميل بموافقته على أي رسوم إضافية ناتجة عن
                    تحديثات حكومية مفاجئة.
                  </AccordionItem>

                  <AccordionItem title="4) مدة الإنجاز">
                    تعتمد مدة تنفيذ أي معاملة على الجهة الحكومية المعنية، ولا
                    تتحكم تأهيل في زمن القرار أو سرعة المعالجة داخل الجهات
                    الرسمية. أي تقدير زمني هو تقدير تقريبي غير ملزم.
                  </AccordionItem>

                  <AccordionItem title="5) التزامات العميل">
                    • يلتزم العميل بتقديم بيانات صحيحة ومكتملة وواضحة.
                    <br />• يتحمل العميل المسؤولية القانونية عن صحة المستندات
                    المقدمة.
                    <br />• أي تأخير أو رفض بسبب بيانات غير صحيحة أو مستندات ناقصة
                    لا تتحمل تأهيل مسؤوليته.
                  </AccordionItem>

                  <AccordionItem title="6) الباقات والاشتراكات (للشركات)">
                    • تحديد الباقة بناءً على عدد الموظفين الفعلي المسجلين رسميًا.
                    <br />• عند زيادة عدد الموظفين تتم الترقية التلقائية دون تعطيل
                    أو فقدان بيانات.
                    <br />• تحتفظ تأهيل بحق مراجعة الاستخدام في حال وجود استخدام
                    مفرط أو غير معتاد.
                  </AccordionItem>

                  <AccordionItem title="7) Pay Per Request (Limited)">
                    باقة محدودة ولا تشمل إدارة مستمرة أو مدير حساب، والأسعار تختلف
                    حسب نوع المعاملة وتعقيدها، ولا يترتب عليها أي التزام مستقبلي
                    من تأهيل.
                  </AccordionItem>

                  <AccordionItem title="8) الذكاء الاصطناعي والمراجعة البشرية">
                    تستخدم تأهيل أنظمة ذكاء اصطناعي للمراجعة المبدئية وتحليل
                    التوافق، ولا يُغني ذلك عن المراجعة البشرية، ويتم اعتماد القرار
                    التشغيلي النهائي بواسطة موظفين مختصين.
                  </AccordionItem>

                  <AccordionItem title="9) الإقامات الذهبية والخدمات الخاصة">
                    تقييم ملفات الإقامة الذهبية وفق المعايير المعتمدة من الجهات
                    المختصة. أي نسب نجاح تعتمد على نتائج سابقة ولا تمثل ضمانًا
                    مستقبليًا. وتحتفظ تأهيل بحق رفض تقديم الخدمة لأي ملف غير قابل
                    للتقديم قانونيًا.
                  </AccordionItem>

                  <AccordionItem title="10) السرية وحماية البيانات">
                    تلتزم تأهيل بالحفاظ على سرية بيانات العملاء واستخدامها لغرض
                    تنفيذ الخدمة فقط، ولا تتحمل مسؤولية اختراقات ناتجة عن أطراف
                    خارجية أو ظروف قهرية.
                  </AccordionItem>

                  <AccordionItem title="11) إيقاف أو تعليق الخدمة">
                    تحتفظ تأهيل بحق تعليق/إيقاف الخدمة في حال مخالفة الشروط أو
                    إساءة استخدام المنصة أو تقديم مستندات مزورة، دون التزام بإعادة
                    رسوم الاشتراك عن الفترة المتبقية.
                  </AccordionItem>

                  <AccordionItem title="12) عدم الاسترداد">
                    جميع الاشتراكات غير قابلة للاسترداد بعد بدء تقديم الخدمة،
                    وتعتبر الخدمة قد بدأت بمجرد تسجيل الطلب أو فتح ملف العميل.
                  </AccordionItem>

                  <AccordionItem title="13) القوة القاهرة">
                    لا تتحمل تأهيل مسؤولية عن التأخير أو عدم التنفيذ بسبب ظروف
                    خارجة عن الإرادة مثل تغييرات قانونية مفاجئة أو أنظمة حكومية أو
                    كوارث طبيعية أو قرارات سيادية.
                  </AccordionItem>

                  <AccordionItem title="14) القانون المعمول به">
                    تخضع هذه الشروط والأحكام وتُفسَّر وفقًا لقوانين دولة الإمارات
                    العربية المتحدة، وتختص محاكم الدولة بالفصل في أي نزاع.
                  </AccordionItem>

                  <AccordionItem title="15) القبول">
                    باستخدام خدمات تأهيل أو الاشتراك في أي باقة، يقر العميل
                    بموافقته الكاملة وغير المشروطة على جميع ما ورد أعلاه.
                  </AccordionItem>
                </div>
              </Card>
              ...
              <Card className="p-6 lg:col-span-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">
                      تأهيل ليست جهة حكومية ولا جهة قرار — القرار دائمًا للجهة
                      المختصة.
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 rounded-3xl bg-black/20 ring-1 ring-white/10 p-5 text-white/75 leading-relaxed">
                  تم إعداد وتنظيم هذا النظام باستخدام نماذج ذكاء اصطناعي متقدمة
                  لإدارة العمليات، مع مراجعة بشرية كاملة لضمان الامتثال القانوني
                  والتنفيذي.
                </div>
                ...
                <div className="mt-5 rounded-3xl bg-black/20 ring-1 ring-white/10 p-5">
                  ...
                  <div className="mt-3 text-xs text-white/55">
                    (جميع الاعتمادات تُستخدم وفق نطاقها الفني والتشغيلي)
                  </div>
                </div>
              </Card>
            </div>
      ...
      <style jsx global>{`
        .aurora {
          background: radial-gradient(
            ...
            radial-gradient(
              900px 600px at 20% 25%,
              rgba(56, 189, 248, 0.18),
              transparent 60%
            ),
            radial-gradient(
              900px 600px at 75% 55%,
              rgba(217, 70, 239, 0.14),
              transparent 60%
            ),
            radial-gradient(
              1000px 700px at 40% 90%,
              rgba(244, 63, 94, 0.12),
              transparent 60%
            );
          filter: blur(34px);
